...
<body>
	...
	디렉토리 하위에 프로젝트와 동일한 톰겟 환경을 만들어서 복사본 파일을 
	실행한다.따라서 아래의 물리적경로는 .metadata하위의 정보가 출력된다.
	 -->	 
	...
	내장객체는 _jsService() 메서드내에서 생성된 지역변수이므로
	...
	*/
	...
	public String useImplicitObject(ServletContext app){
		/* 
		방법2 : 스트립트렛에서 메서드를 호출할때 application내장객체
			를 매개변수로 전달해서 사용한다.
		*/
