...
<body>
	...
	않는 경우라면 EL내장객체없이 속성명 만으로 접근할 수 있다.
	...
	<ul>
		...
		발생한다. 또한 출력시 형변환이 자동으로 되므로 더욱 편리한다.
		 -->
		<li>Person 객체 => 이름 : ${ personObj.name },
						   나이 : ${ personObj.age }</li>
		<li>String 객체 => ${ requestScope.stringObj }</li>
		<!-- 리퀘슨트 영역을 지정하는 requestScope는 생략할 수 있다. -->
		<li>Integer 객체 => ${ integerObj }</li>
	</ul>
	
	<h2>JSP 내장객체를 통해 영역의 값ㅇ읽어오기</h2>
	<%
	...
	<!-- 
	파라미터로 전달된 값을 읽을때 아래 3가지 방법을 사용할 수 있따.
		param.파라미터명
		param['파라미터명']
		param["파라미터명"]
	 -->
