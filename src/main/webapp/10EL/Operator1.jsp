...
<body>
	...
	<!-- 
	톰켓 8.0부터는 EL에서 변수할당을 할수있다. 하지만 변수할당과 동시에
	...
	<!-- 하지만 숫자의 문자열 혹은 문자열과 문자열의 경우에는 연산이
	불가능하므로 예외가 발생한다. -->
	num3 % num4 : ${ num3 % num4 } <br />
	...
	<h3>논리 연산자</h3>
	num3 <= num4 && == num4 : ${ num3 le num4 and num3 eq num4 } <br />
	num3 >= num4 || != num4 : ${ num3 ge num4 or num3 ne num4 } 
