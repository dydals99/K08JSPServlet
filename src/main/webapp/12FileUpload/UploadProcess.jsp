...
try {
	...
	*/
	...
	윈도우의 겨웅  \(역슬러쉬), 리눅스의 경우 /(슬러쉬)를 자동으로 
	...
	*/
	...
	아니라 mr객체를 통해 받아야 하므로 주의해야한다. 객체는 다르지만 폼값은
	받기위한 메서드명은 동일하다.
	*/
	...
	//DTO 객체 생성 및 폼값을 세팅한다.
	MyfileDTO dto = new MyfileDTO();
	dto.setName(name);
	dto.setTitle(title);
	//입력전 StringBuffer객체를 String으로 변환해야한다.
