...
<%-- 	<jsp:useBean id="personhong" class="common.Person" scope="request" />
	<h2>연습문제</h2>
	<ul>
		<li><jsp:getProperty property="name" name="personhong" /></li>
		<li>나이 : <jsp:getProperty property="age" name="personhong" /></li>
		<li>본명 : <%=request.getParameter("paramiter1") %> </li>
		<li>출생 : <%=request.getParameter("paramiter2") %> </li>
		<li>특징 : <%=request.getParameter("paramiter3") %> </li>
	</ul>
	<jsp:include page="inc/ParamInclude.jsp" >
		<jsp:param value="서울시 종로구" name="loc1" />
		<jsp:param value="길동면" name="loc2" />
	</jsp:include> --%>
</body>
</html>