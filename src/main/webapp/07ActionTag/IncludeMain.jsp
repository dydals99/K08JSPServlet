...
//page여역과 request영역에 각각 속성을 저장한다.
...
<body>
	...
	<h3>지시어로 페이지 포함하기</h3>
	<!-- 
	지시어를 이용한 인클루드의 경우 페이지의 경로는 문자열
	형태로만 기술할 수 있다. 표현식을 통해 변수를 사용할 수 없다.
	 -->
	<%@ include file="./inc/OuterPage1.jsp" %>
	<%--@ include file = "<%=outerPath1OuterPage1%>" --%>
	<!-- 지시어를 통한 인클루드는 포함할 파일의 소스를 그대로
	현재 문서에 포함시킨 후 컴파일을 진행한다. 따라서 하나의
	페이지라 생각하면 된다. 그러므로 newVar1은 정상적으로 
	출력된다. -->
	<p>외부 파일에 선언한 변수 : <%=newVar1%></p>
	
	<h3>액션 태그로 페이지 포함하기</h3>
	<!-- 
	액션태그를 이용한 인클루드는 문자열 표현식
	두가지 모두 사용할 수 있다.
	 -->
